...
function ProfilePage(fetchPosts) {
  const {
    id
...
.LElHUfaogaIZIeUrZCB4 .lveRiMysmCc7DCdWosA8 {
  background-color: white;
  border-radius: 0;
  border: none;
  width: auto;
...
.LElHUfaogaIZIeUrZCB4 .lveRiMysmCc7DCdWosA8:hover {
  text-decoration: underline;
  transition: 0.3s ease;
}`, "",{"version":3,"sources":["webpack://./src/components/ProfilePost/ProfilePost.module.scss"],"names":[],"mappings":"AAAA;EACI,aAAA;EACA,iBAAA;EACA,6BAAA;EACA,uBAAA;EACA,qBAAA;EACA,cAAA;EACA,aAAA;EACA,8BAAA;EACA,gCAAA;EACA,kBAAA;AACJ;AAAI;EACI,aAAA;EACA,sBAAA;AAER;AADQ;EACI,WAAA;EACA,YAAA;AAGZ;AADQ;EACI,cAAA;AAGZ;AAAI;EACI,cAAA;AAER;AAAI;EACI,kBAAA;EACA,SAAA;EACA,WAAA;EACA,WAAA;AAER;AAAI;EACI,uBAAA;EACA,gBAAA;EACA,YAAA;EACA,WAAA;EACA,WAAA;EACA,eAAA;EACA,gBAAA;EACA,qBAAA;AAER;AADQ;EACI,0BAAA;EACA,qBAAA;AAGZ","sourcesContent":[".ProfilePost {\n    display: flex;\n    min-height: 30rem;\n    justify-content: space-around;\n    background-color: white;\n    border-radius: .5rem;\n    margin: 2rem 0;\n    padding: 2rem;\n    border: .1rem solid lightgrey;\n    box-shadow: 0 0 .3rem darkgreen;\n    position: relative;\n    .TitleImgContainer {\n        display: flex;\n        flex-direction: column;\n        .ProjectImage {\n            width: 100%;\n            height: 100%;\n        }\n        .ProjectTitle {\n            font-size: 2vw;\n        }\n    }\n    .ProjectDescription {\n        font-size: 1vw;\n    }\n    .ProjectLogo {\n        position: absolute;\n        top: 1rem;\n        right: 1rem;\n        width: 5rem;\n    }\n    .deleteBtn {\n        background-color: white;\n        border-radius: 0;\n        border: none;\n        width: auto;\n        color: blue;\n        font-size: 1rem;\n        font-weight: 200;\n        transition: .3s ease;\n        &:hover {\n            text-decoration: underline;\n            transition: .3s ease;\n        }\n    }\n}"],"sourceRoot":""}]);
// Exports
___CSS_LOADER_EXPORT___.locals = {
...
.z1XFB0qbBjHblp8c_F5M .Fn3Y8z6cyE3sFTgZXhsg .C3y4TdU4vKMpvL4_wj8H .LG29adQOef4sgu1x7iuH .f9PniY17HdeQBxVJqbhw:hover {
  background-color: green;
  transition: 0.3s ease;
}`, "",{"version":3,"sources":["webpack://./src/pages/ProfilePage/ProfilePage.module.scss"],"names":[],"mappings":"AAAA;EACI,cAAA;EACA,UAAA;EACA,YAAA;EACA,mBAAA;AACJ;AAAI;EACI,aAAA;EACA,8BAAA;EACA,WAAA;EACA,iBAAA;AAER;AADQ;EACI,aAAA;EACA,sBAAA;EACA,UAAA;EACA,uBAAA;EACA,qBAAA;EACA,aAAA;EACA,8BAAA;EACA,gCAAA;AAGZ;AAFY;EACI,aAAA;EACA,sBAAA;EACA,uBAAA;EACA,mBAAA;EACA,YAAA;AAIhB;AAHgB;EACI,iBAAA;AAKpB;AAJoB;EACI,WAAA;EACA,0BAAA;EACA,gBAAA;AAMxB;AAFY;EACI,YAAA;AAIhB;AAFY;EACI,YAAA;EACA,aAAA;EACA,6BAAA;EACA,qBAAA;AAIhB;AAHgB;EACI,2BAAA;EACA,mBAAA;EACA,WAAA;EACA,qBAAA;AAKpB;AAJoB;EACI,uBAAA;EACA,qBAAA;AAMxB;AAHgB;EACI,2BAAA;EACA,mBAAA;EACA,WAAA;EACA,aAAA;EACA,qBAAA;AAKpB;AAJoB;EACI,uBAAA;EACA,qBAAA;AAMxB","sourcesContent":[".ProfilePage {\n    margin: 0 auto;\n    width: 80%;\n    height: 100%;\n    padding: 5rem 10rem;\n    .topContainer {\n        display: flex;\n        justify-content: space-between;\n        width: 100%;\n        max-height: 50rem;\n        .userContainer {\n            display: flex;\n            flex-direction: column;\n            width: 25%;\n            background-color: white;\n            border-radius: .5rem;\n            padding: 2rem;\n            border: .1rem solid lightgrey;\n            box-shadow: 0 0 .3rem darkgreen;\n            .imgAndEditContainer {\n                display: flex;\n                flex-direction: column;\n                justify-content: center;\n                align-items: center;\n                width: 15rem;\n                .editBtn {\n                    font-size: 1.2rem;\n                    &:hover {\n                        color: blue;\n                        text-decoration: underline;\n                        transition: none;\n                    }\n                }\n            }\n            .userBio {\n                color: black;\n            }\n            .userLinks {\n                width: 15rem;\n                display: flex;\n                justify-content: space-evenly;\n                margin-bottom: 1.5rem;\n                .ghLogo {\n                    background-color: lightgrey;\n                    border-radius: 100%;\n                    width: 4rem;\n                    transition: .3s ease;\n                    &:hover {\n                        background-color: green;\n                        transition: .3s ease;\n                    }\n                }\n                .portfolioLogo {\n                    background-color: lightgrey;\n                    border-radius: 100%;\n                    width: 4rem;\n                    padding: 1rem;\n                    transition: .3s ease;\n                    &:hover {\n                        background-color: green;\n                        transition: .3s ease;\n                    }\n                }\n            }\n        }\n    }\n}\n\n"],"sourceRoot":""}]);
// Exports
___CSS_LOADER_EXPORT___.locals = {
...
/******/ })()
;
//# sourceMappingURL=App.42b64cf4aeacf8a53ac1e7a0d6734f7a.js.map